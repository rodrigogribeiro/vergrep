...
/* package vergrep-0.1.0.0 */
#ifndef VERSION_vergrep
#define VERSION_vergrep "0.1.0.0"
#endif /* VERSION_vergrep */
#ifndef MIN_VERSION_vergrep
#define MIN_VERSION_vergrep(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_vergrep */
...
#define CURRENT_COMPONENT_ID "vergrep-0.1.0.0-JDR8nRBdMn8GFbUUErRrtv-build"
